		...
		<div class="container">
        	...
        	<div class="right inside">
			    ...
			    if(!Yii::app()->user->isGuest)
			    {
					...
					{
						echo CHtml::link('', array('/dashboard/admin'), array('class'=>'bp-icon icon-inventory', 'data-info'=>'Stan gry'));
					...
					{
						echo CHtml::link('', array('/dashboard/index'), array('class'=>'bp-icon icon-inventory', 'data-info'=>'Stan gry'));
