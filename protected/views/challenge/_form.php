...
<?php echo $form->textFieldRow($model,'value_first_currency', array('value'=>(int)Yii::app()->params['firstCurrencyDefaultReward'], 'size'=>60,'maxlength'=>128)); ?>
<?php echo $form->textFieldRow($model, 'value_second_currency', array('value'=>(int)Yii::app()->params['secondCurrencyDefaultReward'], 'size'=>60, 'maxlength'=>128)); ?>
<br />
